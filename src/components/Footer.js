  ...
  return (
    <div className="text-lg text-center relative isolate px-6 py-24 lg:px-8">
      <div className="mt-10 flex items-center justify-center gap-x-4">
        ...
        <a href="mailto:swarnapudiishwar@gmail.com" rel="noopener noreferrer">
      ...
      <p className="mt-3">
        Created by <span className="font-bold">Ishwar Swarnapudi</span>
      </p>
      <p>Copyright © 2024 PudiIsh's Portfolio. All Rights Reserved</p>
    </div>
  );
}
